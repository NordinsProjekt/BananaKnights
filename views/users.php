...
function SignUpForm($message)
{
    ...
    <td><input type='text' id='txtUsername'name='Username' pattern='.{4}' /></td></tr>";
    $text .= "<tr> <td><label for='txtPassword' />Lösenord </label></td>
    <td><input type='password' id='txtPassword'name='Password' pattern='.{8}' /></td></tr>";
    $text .= "<tr> <td><label for='txtConfirmPassword' />Bekräfta lösenord: </label></td>
    <td><input type='password' id='txtConfirmPassword'name='ConfirmPassword' pattern='.{8}' /></td></tr>";
    $text .= "<tr> <td><label for='txtEmail' />Email </label></td>
    <td><input type='email' id='txtEmail'name='Email' /></td></tr>";
